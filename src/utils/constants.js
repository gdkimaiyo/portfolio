...
export const EXPERIENCE = [
  {
    ...
    experience: [
      "Developed and optimised automated CI/CD pipelines using GitHub Actions, AWS SSM and Amazon ECS. Implemented security scans and automated tests which reduced manual QA time by 30%.",
      "Deployed and managed scalable multi-cloud infrastructure on AWS and GCP ensuring high availability, consistency of environments and zero-downtime deployments.",
      "Led application modernisation initiatives to containerise legacy systems using Docker and implement AWS ECS auto-scaling to reliably accommodate traffic spikes.",
      "Improved database performance for MongoDB and reduced backend API latency under load by redesigning database schemas, optimising aggregations, and implementing strategic indexing.",
      "Worked with development, security and QA teams to promote DevOps culture, optimise release management processes and enforce cloud security standards.",
    ],
    technologies: [
      "AWS",
      "GCP",
  ...
  },
  {
    ...
    experience: [
      "Developed, scaled and maintained production level features for AI powered life science research platform assistant that helps accelerate global health drug discoveries using React, Python (Django), MongoDB, AWS and GCP.",
      "Designed and built an enterprise EdTech platform for life sciences companies to run course content, track progress, and develop AI-driven study pathways",
      "Built a secure telehealth platform that connects therapist and client using Angular, NodeJs and MongoDB",
      "Developed Django microservices powered by RAG (Retrieval-Augmented Generation) and Intelligent Research Assistants to enable users to query complex scientific literature, lecture slides, and institu- tional repositories with natural language.",
      "Built core AI-Powered Document Writer and collaborative workspace modules that allow multi-user content editing in real-time, dynamic task tracking, and automated document generation (summaries, quizzes, flashcards).",
      "Developed frontend user interfaces using React to power 50+ specialized Scientific Analytical Tools (mRNA analysis, drug discovery) and real-time student/research engagement analytics dashboards.",
      "Implemented the payment and billing infrastructure by integrating the Stripe API and built subscription plan UI and pricing page. Implemented full checkout lifecycle (success, failure and retry logic), dynamic tier provisioning and automated subscription renewal and cancellations using celery",
      "Authored RESTful API documentation, optimized database aggregation pipelines and maintained high standards for code quality, data security and significantly reduced API latency.",
      "Collaborated with product managers, domain scientists and designers in Agile methodologies to deliver complex, business critical life science solutions.",
      "Implemented complex auth flows using Cognito and OIDC to ensure sensitive health and research data is secure and compliant across all platforms.",
      "Build an admin dashboard to easily track and monitor clients and therapists sessions.",
    ],
    technologies: [
      "React",
      "Python",
  ...
  },
  {
    ...
    experience: [
      "Led the development of full-stack features with React (Chakra UI), Node.js/Express.js and MongoDB for venture builder studio aiming to provide ethical, representative AI solutions for global health ventures and journeys",
      "Built secure, custom backend authentication systems with Node.js for investor and admin sign-up, sign-in and referral tracking workflows.",
      "Designed and delivered a role-based Investor Portal UI with React, allowing investors to securely access, download and submit essential documents.",
      "Built automated document processing pipelines and admin management workflows to enable admins to review, process, approve or request revisions on uploaded investor submissions in real-time.",
      "Built scalable backend endpoints for file upload, validation and status tracking to support investment onboarding and maintain data integrity.",
    ],
    technologies: [
      "React.js",
      "Node.js",
